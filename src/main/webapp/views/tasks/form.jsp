...
<t:layout title="${empty task ? 'Create' : 'Edit'} Task">
  ...
  <input type="datetime-local" id="dueDate" name="dueDate" value="${task.dueDate}" required
  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
  </div>
  ...
  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
      ...
      <div class="mb-4">
    <label for="assignedTo" class="block text-gray-700 text-sm font-bold mb-2">Assigned To:</label>
    ...
    <div class="flex items-center justify-between">
      ...
      <a href="${pageContext.request.contextPath}/tasks" class="inline-block align-baseline font-bold text-sm text-gray-700 hover:text-gray-900 hover:underline">
        Cancel
      </a>
    </div>
  </form>
